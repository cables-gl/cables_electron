...
class ElectronApi
{
    ...
    async installProjectDependencies()
    {
        ...
        if (!currentProject)
        {
            return this.success({ "stdout": "please save your project first", "packages": [] });
        }
            ...
            if (opName)
            {
                ...
                if (packageNames.length > 0)
                {
                    const newPackageJson = {
                        "name": "cables-op",
                        "description": "AUTOGENERATED FILE, CHANGES WILL BE OVERWRITTEN",
                        "private": true,
                    ...
                    try
                    {
                        ...
                        jsonfile.writeFileSync(path.join(packageDir, "package.json"), newPackageJson, { "encoding": "utf-8", "spaces": 4 });
                        ...
                        const out = execaSync(npm, ["install", "--legacy-peer-deps", "--prefix", packageDir], { "cwd": packageDir });
                    ...
                    {
                        results.push({ "stderr": e, "packages": packageNames });
                        hasError = true;
                    }
                }
            }
